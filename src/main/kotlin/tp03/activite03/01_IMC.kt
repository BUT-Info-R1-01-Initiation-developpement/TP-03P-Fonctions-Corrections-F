...
fun affichageMessagePourImc(imc: Double) {
    ...
    println(when {
        imc < 18.5 -> "Cet IMC correspond à une insuffisance pondérale."
        imc < 25.0 -> "Cet IMC correspond à une corpulence normale."
        imc < 30.0 -> "Cet IMC correspond à du surpoids."
        else -> "Cet IMC correspond à de l'obésité."
    })
}
